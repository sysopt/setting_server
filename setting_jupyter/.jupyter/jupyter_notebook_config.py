...
c.NotebookApp.notebook_dir = 'webdata'
...
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$2V8bSY0yF+82TNf9eHI/BA$fubsC3mkcV59ax9AU8yZUg'
...
#  Choices: any of ['blake2b', 'sha3_224', 'sha3_512', 'sha1', 'blake2s', 'sha256', 'md5', 'sha3_384', 'sha3_256', 'sha384', 'sha512', 'sha224']
#  Default: 'sha256'
